...
final class SignUpFormFactory
{
    ...
    public function create(callable $onSuccess): Form
    {
        ...
        $form->addRadioList('role', 'Registruji se jako', [
                'member' => 'Člen',
                'parent' => 'Rodič',
            ])
            ->setDefaultValue('member')
            ->setRequired('Vyberte typ účtu.');
        ...
        $form->onSuccess[] = function (Form $form, \stdClass $data) use ($onSuccess): void {
            ...
            // Pouze member a parent jsou povolené role při registraci
            $role = in_array($data->role, ['member', 'parent'], true) ? $data->role : 'member';
