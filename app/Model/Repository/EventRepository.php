...
final class EventRepository
{
    ...
    {
        return $this->database->table('event_categories')
            ->order('id ASC');
    }

    public function findUpcomingByCategory(int $categoryId): Selection
    {
        return $this->database->table('events')
            ->where('is_published', true)
            ->where('start_date >= ?', new \DateTime())
    ...
    public function findPastByCategory(int $categoryId): Selection
    {
        return $this->database->table('events')
            ->where('is_published', true)
            ->where('start_date < ?', new \DateTime())
