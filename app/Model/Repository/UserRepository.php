...
final class UserRepository
{
    ...
    /**
     * Pole rozsirenych profilovych udaju (pro formulare)
     */
    public const EXTENDED_FIELDS = [
        'street', 'city', 'zip', 'birth_date',
        'is_pathfinder_member', 'is_vegetarian', 'dietary_notes',
        'allergies', 'health_notes', 'medications', 'can_swim', 'clothing_size',
    ];
